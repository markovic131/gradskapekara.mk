<div class="greenWrapper" id="about-us">
...
<div class="container segment" id="quality">
    <section>
        <div class="row">
            <div class="col-md-12">
...
<div class="redWrapper">
    <div class="container segment" id="our-location">
        <section id="location">
            <h1>Локации</h1>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6 text-muted">
                    ...
                    <address>
                        <i class="fas fa-location-circle"></i> Октомвриска Револуција 32, 1300 Куманово<br>
                        <i class="fas fa-phone-square-alt"></i> 031 550 580<br>
                        <i class="fas fa-mobile-alt"></i> 078 422 232
                    </address>
                    <div class="kgp-map">
